...
date: "`r format('18 February 2019')`"
urlcolor: blue
output:
  pdf_document:
    fig_caption: yes
...
If you have any suggestions or want to report an error, please visit the GitHup page of the package [here](https://github.com/pedro-andrade-inpe/colrow).
