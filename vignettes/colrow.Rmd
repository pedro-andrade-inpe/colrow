...
If you want to save this plot or any other created within R into a file, it is
...
in order to define a common legend. The following code creates six pdf files,
