...
date: "`r format('28 September 2023')`"
urlcolor: blue
...
vignette: |
  ...
  %\VignetteIndexEntry{colrow: Handling SimU, CR, and LU data}
---
...
with this data is stored in file `br_biomes.gpkg` available within `colrow` package. We will
use CR data from `brazilLandCompare.gpkg`, created previously in this tutorial.
...
The next step is to select a palette from the functions available in `RColorBrewer`, using `brewer.pal()`
